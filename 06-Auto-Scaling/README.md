...
• Public Browser Access:
  Navigated to [http://13.207.186.56](http://13.207.186.56) in the web browser to verify live access over Port 80.
...
1. Web Page Connection Timeout (ERR_CONNECTION_TIMED_OUT)
   • Problem: Accessing the public IPv4 address ([http://13.207.186.56](http://13.207.186.56)) in the browser timed out.
   • Root Cause: 
     1. Apache web server service was not started on launch.
     2. Brave Browser was automatically enforcing HTTPS on raw IP addresses.
